    ...
    methods: {
        ...
        inputChange: function inputChange(e) {
            ...
            this.timerId = setTimeout(function () {
                _this.data.autoSearch(e.detail.value).then(function (json) {
                    _this.setData({
                        result: json
                    });
                }).catch(function (err) {
        ...
        search: function search() {
            ...
            var _this = this;
            this.data.search(this.data.value).then(function(json) {
                _this.setData({
                    result: json
                });
            }).catch(function(err) {
        ...
        slideButtonTap: function slideButtonTap(e) {
            var index = e.currentTarget.dataset.index;
            var item = this.data.result[index];
            this.triggerEvent('slidebuttontap', { index: index, item: item , data: e.detail.data});
        },
        buttonTap: function(e) {
            this.triggerEvent('buttontap', e.detail);
        },
        _triggerSearch: function _triggerSearch(newVal) {
            if (newVal) {
                this.search();
            }
        }
